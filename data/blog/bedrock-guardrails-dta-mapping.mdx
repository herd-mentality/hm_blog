...
The [DTA](https://www.dta.gov.au/articles/trustworthy-ai-agents-new-technical-guidance)'s updated AI policy made an internal register of in-scope AI use cases mandatory from 15 June 2026. The [AI Impact Assessment](https://www.digital.gov.au/ai/impact-assessment-tool/introduction) requirement, which agencies must complete for every in-scope use case (agentic systems included) before deployment, follows on 15 December 2026. The [agentic AI addendum](https://www.digital.gov.au/policy/ai/agentic-ai-addendum-background) itself sits alongside this policy as best-practice technical guidance and doesn't carry a separate compliance date of its own.
...
For my tool, where the AI produces advice and a human practitioner acts on it, HOTL is the right mode. The agent never submits data or applications to any government agency; the practitioner does.
