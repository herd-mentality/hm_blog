...
[lex-au-search](https://github.com/cchew/lex-au-search) is the application this compliance architecture is being built for, and it's public on GitHub. The guardrails testing itself is a five-minute `ApplyGuardrail` call against your own guardrail ID: point it at yours and check whether your ANONYMIZE and tag-scoping assumptions hold up the same way mine didn't.
