...
3. Run the following command in your terminal, which will provide you with a link. Copy this link into a browser, follow the prompts, then copy the provided authorisation code back into the terminal and press Enter.
