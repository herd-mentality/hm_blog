...
![](/static/images/hiphop-graph-no-label-avatar.png)

# 1 Introduction

As a Hip-hop fan (and other genres of music) it is obvious that certain artists are more alike than others.
I was interested to see if a network of Hip-hop artists based on their collaborations with others would be able highlight some interesting insights.
...
![](/static/images/hiphop-graph-chatgpt.png)
...
![](/static/images/hiphop-graph-gephi-screenshot.png)
...
![](/static/images/hiphop-graph-label.png)

### 4.1 Most collaborations

![](/static/images/hiphop-graph-snoop.png)

The winner of this title goes to Snoop Dogg.

### 4.1 Clusters

![](/static/images/hiphop-graph-clusters.png)
...
![](/static/images/hiphop-graph-drdre-50cent.png)
