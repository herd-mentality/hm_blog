...
`www.basketball-reference.com/players/i/{player_code}/gamelog/{year}`. Using this as a template, I have made the below function that can scrape the gamelog table for a given player code and year.
