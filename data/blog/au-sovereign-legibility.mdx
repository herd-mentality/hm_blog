...
An AI agent can describe an Australian government service accurately: what the payment is, who is eligible, roughly what the steps are. It cannot reach one. Ask it to get to the form a real person would fill in and it stalls at a hover-only menu it cannot open or a login wall it must not cross.

In Australia, 21% of people report using generative AI to find information about government services, rising to 29% among daily AI users ([Publicis Sapient's 2025 Digital Citizen Report](https://www.publicissapient.com/resources/research/citizen-insights-hub), also cited in RADAR below). So this is a channel problem, not a hypothetical.
