...
<div className="flex justify-center">
    <Image src="/static/images/meridian-geospatial/architecture.svg" alt="Component flow: Streamlit UI to Claude tool use to GeoPandas/DuckDB to ArcGIS OD Matrix routing to PuLP MCLP optimiser to Claude narrative to Folium/Plotly map" width={290} height={830} />
</div>
...
4. **Routing Layer** (ArcGIS Online Network Analyst REST API): travel time matrix for demand points vs facility locations; pre-computed and disk-cached as Parquet to minimise app response times
...
<div className="flex justify-center">
    <Image src="/static/images/meridian-geospatial/before-after-stats.jpg" alt="Before/after coverage statistics panel" width={600} height={346} />
</div>
...
For the MCLP formulation and its health planning applications, [Church and ReVelle (1974)](https://www.semanticscholar.org/paper/The-maximal-covering-location-problem-Church-Revelle/c3de804bbeb15b0d8570ee3d9f4cbdf432993cfa) is the original paper. [ReVelle and Eiselt (2005)](https://www.semanticscholar.org/paper/Location-analysis:-A-synthesis-and-survey-Revelle-Eiselt/e5018d3b4ed2af7a1e2630114d896e607e7be692) surveys the broader facility location literature.

For Australian PHN geography and health workforce data: [AIHW](https://www.aihw.gov.au/), [Health Workforce Dataset](https://hwd.health.gov.au/) and [Healthdirect service finder](https://www.healthdirect.gov.au/australian-health-services).
